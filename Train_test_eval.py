...
if __name__ == "__main__":
    ...
    parser.add_argument('--pretrained_model', default='./pretrained_model/pvt_v2_b3.pth', type=str, help='load Pretrained model')
    ...
    parser.add_argument('--arch', default= 'pvt_v2_b3', type=str, help='name of the model to train or test')
    ...
    parser.add_argument('--methods', type=str, default='PVST', help='evaluated method name')
